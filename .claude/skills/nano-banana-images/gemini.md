...
|-------------|---------|--------|
| `generate_gemini.py` | Python script to call Google Gemini API and save generated image | **Active** |
| `generate_kie.py` | Legacy script for Kie.ai API (deprecated — replaced by generate_gemini.py) | Deprecated |
| `get_kie_image.py` | Legacy script to retrieve Kie.ai task result (deprecated) | Deprecated |
